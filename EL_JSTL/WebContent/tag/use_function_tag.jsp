...
<body>
<c:set var="str1" value="Functions 태그사용" />
...
substringBefor(str2,str2) = "${fn:substringBefore(str1,str2) }"<br>
...
containsIgonreCase(str1,str2) ="${fn:containsIgnoreCase(str1,str2) }"<br>
