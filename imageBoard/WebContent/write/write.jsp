...
<%
FileUploadRequestWrapper requestWrap = new FileUploadRequestWrapper(request, -1, -1, "C:\\Users\\sungw\\Desktop\\Java\\imageBoard\\WebContent\\temp");
...
if(imageFileItem.getSize() >0){
	...
	//이미지를 지정한 경로에 저장
	File imageFile = new File("C:\\Users\\sungw\\Desktop\\Java\\imageBoard\\WebContent\\image",image+".small.jpg");
