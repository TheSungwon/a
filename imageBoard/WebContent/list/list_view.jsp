...
int currentPage = Integer.parseInt("search_key");
...
<c:if test="<%=searchCondTitle || searchCondNmae %>">
검색[
<c:if test="<%=searchCondTitle %>"> title</c:if>
<c:if test="<%=searchCondNmae %>" >name </c:if>
=${param.search_key }
...
<tr>
	<td colspan="4" align="right"> <a href="../write/writeForm.jsp"> image </a></td></tr>
</table>
...
function goView(id){
	document.move.action="../read/read.jsp";
